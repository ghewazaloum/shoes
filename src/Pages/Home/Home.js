...
import { Curves,FooterCurves, Navbar,Information ,ShoeContainer,UnFocusedButton,DisplayShoes, Headers, Button, WideButton, Colors, Card,Footer} from '../../components/index';
import { ButtonContainer,TinyGlassContainer, CardContainer, Container, GlassContainer, Separator, ShoesContainer, SmallGlassContainer } from '../../sections/index';
    ...
    return(
        ...
        <ShoesContainer>
            <svg width="1804" height="825" viewBox="0 0 1804 825" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M235 667C28.6668 783 -226.6 945.4 403 667C1190 319 2203 -287.5 1633 168C1063 623.5 890 776.5 1031.5 767" stroke="black" strokeWidth="8"/>
            </svg>
            <Information>
              <span>About Us</span>
